...
import getThemeById from '@/services/getThemeById';
import updateThemeById from '@/services/updateThemeById';
    ...
    const handleSubmit = () => {
        ...
        updateThemeById(id, theme).then((response: any) => {
            if (response) {
                ...
                setAlertInfo('Tema atualizado com sucesso!');
                setOpenAlert(true);
                ...
                setAlertType('error');
                setAlertInfo('Erro ao atualizar tema!');
                setOpenAlert(true);
                setTimeout(() => {
                    setOpenAlert(false);
                }, 3000);
            ...
            <Main>
                <div style={{
                    ...
                    <p style={{
                        ...
                        color: 'var(--text-color-primary)',
                        marginBottom: '12px',
                    }}>utilize o formulário abaixo para editar o tema selecionado!</p>
                    <div style={{
                        display: 'flex',
                        flexDirection: 'column',
                        alignItems: 'center',
                        ...
                        <Form>
                            ...
                            <FormGroup>
                                ...
                                }} value={theme.descricao} onChange={(event: React.ChangeEvent<HTMLTextAreaElement>) => {
                                    setTheme({
                                        ...theme,
